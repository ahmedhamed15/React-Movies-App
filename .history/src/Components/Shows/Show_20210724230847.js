...
const Show = (props) => {
    ...
    const bgImg = {
        background: `linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(https://images.amcnetworks.com/ifcfilms.com/wp-content/uploads/2020/03/sixmins.jpg) no-repeat center center fixed`
    }
